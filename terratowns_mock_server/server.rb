...
# by setting a global variable, never use a global variable in production
$home = {}
...
# turn this generic class to ulitlize the sinatra web-framework
class TerraTownsMockServer < Sinatra::Base
  ...
  # return a hardcode access token
  def x_access_code
  ...
  def find_user_by_bearer_token
    ...
    # Does the token match in the one in the database
    # If we can not find it or no match, turn an error
    ...
    # the code and user_uuid should present and matching the user
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    begin
      ...
      # Like rails so we need to manually parse
    ...
    # printing the variables out to console to make easier to read
    ...
    # ensure validations check pass, or return errors back as json
    unless home.valid?
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid match the database
